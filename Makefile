...
# Generated by qmake (2.01a) (Qt 4.3.4) on: Tue Oct 7 12:12:36 2008
...
SOURCES       = main.cpp \
		prog8051.cpp \
		progThread.cpp moc_prog8051.cpp \
		moc_progThread.cpp
OBJECTS       = main.o \
		prog8051.o \
		progThread.o \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/programmer1.0.0/ && $(COPY_FILE) --parents prog8051.h progThread.h .tmp/programmer1.0.0/ && $(COPY_FILE) --parents main.cpp prog8051.cpp progThread.cpp .tmp/programmer1.0.0/ && $(COPY_FILE) --parents prog8051.ui .tmp/programmer1.0.0/ && (cd `dirname .tmp/programmer1.0.0` && $(TAR) programmer1.0.0.tar programmer1.0.0 && $(COMPRESS) programmer1.0.0.tar) && $(MOVE) `dirname .tmp/programmer1.0.0`/programmer1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/programmer1.0.0
...
moc_progThread.cpp: qextserialport.h \
